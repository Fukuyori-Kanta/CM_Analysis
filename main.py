...
if __name__ == '__main__':
    ...
    try:   
        ...
        # パス設定
        root_path, video_path, cmData_top_path, cmData_btm_path, cut_path, cut_img_path, cut_point_path, noun_label_path, verb_label_path, label_path, scene_path, scene_data_path = setup_path() 
